              ...
              <div className="tiles-item reveal-from-bottom" data-reveal-container=".tiles-wrap" data-reveal-delay="400">
                <div className="tiles-item-inner">
                  ...
                  <div className="features-tiles-item-content">
                    ...
                    <p className="m-0 text-sm">
                      Allow new employees to hit the ground running with our AI-driven onboarding solutions. Free up HR resources and ensure a seamless onboarding experience.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="tiles-item reveal-from-bottom" data-reveal-container=".tiles-wrap" data-reveal-delay="500">
                <div className="tiles-item-inner">
                  ...
                  <div className="features-tiles-item-content">
                    ...
                    <p className="m-0 text-sm">
                      Custom AI solutions that align with your business objectives. Get in touch with us to discuss your unique needs.
                    </p>
                  </div>
                </div>
              </div>              
